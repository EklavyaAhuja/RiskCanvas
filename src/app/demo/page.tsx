    ...
    <div className="w-full h-screen bg-black relative overflow-hidden">
      ...
      {activeEffect === "combined" && (
        <>
          <MeshGradient
            ...
            colors={["#000000", "#1a1a1a", "#333333", "#ffffff"]}
            speed={speed * 0.5}
            // wireframe="true" // Usually prop is boolean
            backgroundColor="#000000"
          />
      ...
      <div className="absolute inset-0 pointer-events-none p-8">
        ...
        <div className="absolute top-8 left-8 pointer-events-auto">
          <h1 className="text-white font-mono text-lg font-bold tracking-tighter">SHADER_LABS // 01</h1>
          <p className="text-white/40 text-xs font-mono mt-2 uppercase tracking-widest">Procedural Visual Systems</p>
        </div>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full font-mono text-[10px] uppercase tracking-widest border transition-all ${
                activeEffect === effect 
                  ...
                  : 'bg-black/40 text-white/60 border-white/20 hover:border-white/40'
              }`}
            >
              {effect}
            </button>
        ...
        {/* Parameter Controls */}
        <div className="absolute bottom-8 right-8 pointer-events-auto space-y-6 w-64 bg-black/40 backdrop-blur-xl p-6 rounded-2xl border border-white/10">
